...
import vn.sonnl.gigaman.entities.Score;
import vn.sonnl.gigaman.entities.SoundButton;
import vn.sonnl.gigaman.entities.StartButton;
import vn.sonnl.gigaman.entities.Tutorial;
...
public class GameStage extends Stage implements ContactListener {
    ...
    private void setUpGameTitle() {
        Rectangle gameTitleBounds = new Rectangle(0, getCamera().viewportHeight * 7 / 8,
                getCamera().viewportWidth, getCamera().viewportHeight / 4);
        addActor(new GameTitle(gameTitleBounds));
    }
