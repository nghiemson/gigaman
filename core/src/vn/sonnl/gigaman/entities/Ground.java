...
public class Ground extends GameActor {
    ...
    public Ground(Body body) {
        super(body);
        textureRegion = Assets.getTextureRegion(Constants.GROUND_ASSETS_ID);
    ...
    private void resetBounds() {
        ...
        textureRegionBounds2 = new Rectangle(textureRegionBounds1.x + screenRectangle.width, 0, screenRectangle.width*1.5f,
